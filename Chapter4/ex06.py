...
#         "message": "아이템 생성",
#         "data": data
#     }, ensure_ascii=False)  # 한글이 깨지지 않게 설정

#     return Response(response=response_body, status=201, mimetype="application/json")
